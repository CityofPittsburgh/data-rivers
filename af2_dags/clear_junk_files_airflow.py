...
# The goal of this DAG is to clear out junk files which accumulate in data-rivers-testing/data-rivers/data-confluence-314416
# buckets/datasets as a matter of routine development tests and procedures. This will run monthly and delete all files in the
