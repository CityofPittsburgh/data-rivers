...
json_loc = f"{dataset}/2020/2020_timekeeping_backfill.json"
...
ceridian_timekeeping_backfill_bq_load = GoogleCloudStorageToBigQueryOperator(
    ...
    destination_project_dataset_table=f"{os.environ['GCLOUD_PROJECT']}.ceridian.2020_timesheet_report",
...
CREATE OR REPLACE TABLE `{os.environ['GCLOUD_PROJECT']}.ceridian.historic_timekeeping` AS
    ...
    UNION DISTINCT
    SELECT DISTINCT * FROM `{os.environ['GCLOUD_PROJECT']}.ceridian.2020_timesheet_report`
"""
