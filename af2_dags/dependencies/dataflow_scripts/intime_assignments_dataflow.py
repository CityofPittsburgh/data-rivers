...
from dataflow_utils.dataflow_utils import JsonCoder, SwapFieldNames, generate_args, ChangeDataTypes, FilterFields, \
    CrosswalkDeptNames, StripBeforeDelim, ColumnsCamelToSnakeCase
...
def run(argv=None):
    ...
    with beam.Pipeline(options=pipeline_options) as p:
        ...
        load = (
                ...
                | beam.ParDo(CrosswalkDeptNames('Department_LongName', os.environ['intime_DEPT_FILE']))
