...
class TestDataflowUtils(unittest.TestCase):
    ...
    def test_geocode_address(self):
        ...
        tga_1 = dataflow_utils.geocode_address(datum_1, address_field_1)
        tga_1['lat'] = round(tga_1['lat'], 7)
        tga_1['long'] = round(tga_1['long'], 7)
        self.assertEqual(tga_1, expected_1)

        datum_2 = {"ADDRESS": "9999 500TH AVE, PA 15"}
        expected_2 = {"ADDRESS": "9999 500TH AVE, PA 15", 'lat': None, 'long': None}
        tga_2 = dataflow_utils.geocode_address(datum_2, address_field_1)
        self.assertEqual(tga_2, expected_2)

        ### Add test case for incorrectly-formatted address
        datum_3 = {"ADDRESS": "PITTSBURGH 12"}
        tga_3 = dataflow_utils.geocode_address(datum_3, address_field_1)
        print(tga_3)
