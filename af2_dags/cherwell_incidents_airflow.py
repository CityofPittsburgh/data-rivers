...
number_of_escalations, requester_department, requester, on_behalf_of, customer, comments, close_description,
...
upd_fields = ['status', 'service', 'priority', 'last_modified_date_EST', 'last_modified_date_UTC',
              'last_modified_date_UNIX', 'closed_date_EST', 'closed_date_UTC', 'closed_date_UNIX', 'assigned_team',
              'assigned_to', 'assigned_to_manager', 'responded_date_EST', 'responded_date_UTC', 'responded_date_UNIX',
              ...
              'requester_department', 'requester', 'customer', 'incident_reopened', 'comments', 'close_description']
